...
//     const selectTemplate = document.getElementById("product-options-template").content.cloneNode(true);
//     const selectHTML = selectTemplate.querySelector("select").outerHTML;

//     cell1.innerHTML=`<div class="mb-3 d-flex"><button type="button"  style="margin: 0px 5px;" class="btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></button>${selectHTML}</div>`
